    ...
    @injectable()
    class ClassroomTeamValidateEscola implements IClassroomTeamServiceStrategy{
        constructor(
          ...
          async validate_create({ classroom_id, name, creator_id }: ICreateClassroomTeamEscolaDTO): Promise<boolean> {
    ...
    export { ClassroomTeamValidateEscola };
