...
import { HomeworkServiceEscola } from "../Service/HomeworkService";

class HomeworkControllerEscola extends HomeworkController{
    async giveGrade(request: Request, response: Response): Promise<Response>{
        ...
        const homeworkService = container.resolve(HomeworkServiceEscola);
